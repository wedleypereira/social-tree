...
<div id="container" class="w-full max-w-lg mt-14 px-6 m-auto text-center">
  ...
  >
    <button
      class="pointer size-8 absolute top-1/2 -translate-y-1/2 z-1 left-0 animate-slide-back light:animate-slide-in bg-white hover:outline-8 hover:outline-white/20 light:hover:outline-black/10 rounded-full bg-[url('/moon-stars.svg')] light:bg-[url('/sun.svg')] bg-no-repeat bg-center"
    ></button>
    <span
